...
const Contact = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-screen py-32 px-6 overflow-hidden">
      {/* Background Effects */}
          ...
          >
            <div className="relative p-8 bg-card/50 backdrop-blur-sm border-2 border-primary/30 rounded-2xl hover-glow-cyan">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="group relative w-full px-6 py-4 bg-primary/10 border-2 border-primary rounded-lg font-semibold text-primary hover-glow-cyan overflow-hidden transition-all"
                >
