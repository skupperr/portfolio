...
//     skills: [
//       { name: 'BeautifulSoup', icon: '/icons/beautifulsoup.png', description: 'Parsed HTML and XML for web scraping tasks.' },
//       { name: 'Playwright', icon: '/icons/playwright.png', description: 'Automated browser tasks for testing and scraping.' },
//       { name: 'Git', icon: '/icons/git.png', description: 'Managed source code versions for collaborative projects.' },
//       { name: 'GitHub', icon: '/icons/github.png', description: 'Hosted and collaborated on software development projects.' },
//       { name: 'VS Code', icon: '/icons/vscode.png', description: 'Optimized development workflow with a powerful code editor.' },
//       { name: 'Jupyter', icon: '/icons/jupyter.png', description: 'Prototyped and documented data science projects interactively.' },
//     ],
//   },
// ];
...
//         ) : (
//           <span className="text-2xl font-bold text-cyan-300 drop-shadow-[0_0_6px_rgba(0,255,255,0.4)]">
//             {name.charAt(0)}
//           </span>
//         )}

//         <div className="absolute inset-0 rounded-full transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(0,255,255,0.5)]"></div>
//       </div>
...
//   const coreCompetencies = skillsData.find((cat) => cat.title === 'Core Competencies');
//   const technologySkills = skillsData.filter((cat) => cat.title !== 'Core Competencies');
...
//       <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,_rgba(217,70,239,0.08),transparent_40%)]"></div>
...
//               >
//                 {coreCompetencies.skills.map((skill, index) => (
...
//           {technologySkills.map((category, catIndex) => (
